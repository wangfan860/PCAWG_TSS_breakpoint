...
if __name__ == '__main__':
    ...
    distance_table1=pd.read_csv('/gpfs/data/lyang-lab/labshare/fan/distance84149x1214_0627.csv',index_col=0)
    expr=pd.read_csv('/gpfs/data/lyang-lab/labshare/fan/correct_oldnorm_expression84149x1214_0630.csv', index_col=0)
    ...
    table.to_csv('/gpfs/data/lyang-lab/labshare/fan/4th_run_correct_oldnorm/ranksum_{}.csv'.format(disease))
