...
if __name__ == '__main__':
    ...
    expr=pd.read_csv('/gpfs/data/lyang-lab/users/fan/newnorm_expression84149x1214_0627.csv', index_col=0)
    ...
    table.to_csv('/gpfs/data/lyang-lab/users/fan/one_sided_newnorm_300kb/ranksum_{}.csv'.format(disease))
